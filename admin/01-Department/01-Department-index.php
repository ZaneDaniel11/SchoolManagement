...
<head>
    ...
    <link rel="stylesheet" href="CSS-Department/Index.css">
        ...
        <tbody>
            ...
            if ($stmt) {
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <td>' . $name . '</td>
                    <td><div class="alb"><img src="../01-Department/Images-Department/' . $logo . '"></div></td>
                    <td><a href="department_update.php?update_id=' . $id . '" class="edit_btn"><button type="button" class="btn btn-primary">Update</button></a></td>
                    <td><a href="Department-Delete.php?delete_id=' . $id . '"><button type="button" class="btn btn-danger">Delete</button></a></td>
                    </tr>';
                }
            }
